...
int set_dcdc1(unsigned int mvolt)
{
	...
	return i2c.write_nbyte(axp152.addr,AXP152_DCDC1_VOLTAGE,&target,1);
}
/*
 * Name								: set_dcdc2
 * Description				: ---
...
int set_dcdc2(unsigned int mvolt)
{
	...
	return i2c.write_nbyte(axp152.addr,AXP152_DCDC2_VOLTAGE,&target,1);
}
/*
 * Name								: set_dcdc3
 * Description				: ---
...
int set_dcdc3(unsigned int mvolt)
{
	...
	return i2c.write_nbyte(axp152.addr,AXP152_DCDC3_VOLTAGE,&target,1);
}
/*
 * Name								: set_dcdc4
 * Description				: ---
...
int set_dcdc4(unsigned int mvolt)
{
	...
	return i2c.write_nbyte(axp152.addr,AXP152_DCDC4_VOLTAGE,&target,1);
}
/*
 * Name								: set_dldo1
 * Description				: ---
...
int set_dldo1(unsigned int mvolt)
{
	...
	return i2c.write_nbyte(axp152.addr,AXP152_DLDO1_VOLTAGE,&target,1);	
}
/*
 * Name								: set_dldo2
 * Description				: ---
...
int set_dldo2(unsigned int mvolt)
{
	...
	return i2c.write_nbyte(axp152.addr,AXP152_DLDO2_VOLTAGE,&target,1);
}
/*
 * Name								: set_aldo1
 * Description				: ---
...
int set_aldo1(unsigned int mvolt)
{
	...
	i2c.read_nbyte(axp152.addr,AXP152_ALDO1_ALD02_VOLTAGE,&data,1);
	...
	return i2c.write_nbyte(axp152.addr,AXP152_ALDO1_ALD02_VOLTAGE,&target,1);
}
/*
 * Name								: set_aldo2
 * Description				: ---
...
int initialize(void)
{
	...
	i2c.read_nbyte(AXP152_I2C_ADDR,AXP152_CHIP_VERSION,&ver,1);
	
	if(ver != 0x05){
		HAL_Delay(10);
		i2c.read_nbyte(AXP152_I2C_ADDR_1,AXP152_CHIP_VERSION,&ver,1);
		if(ver != 0x05){
			HAL_Delay(10);
			i2c.read_nbyte(AXP152_I2C_ADDR_2,AXP152_CHIP_VERSION,&ver,1);
			if(ver != 0x05){
				HAL_Delay(10);
				i2c.read_nbyte(AXP152_I2C_ADDR_3,AXP152_CHIP_VERSION,&ver,1);
				if(ver != 0x05){
					axp152.version = ver;
					return -1;
				}else{
					axp152.addr = AXP152_I2C_ADDR_3;
					axp152.version = ver;
				}
			}else{
				axp152.addr = AXP152_I2C_ADDR_2;
				axp152.version = ver;
			}
		}else{
			axp152.addr = AXP152_I2C_ADDR_1;
			axp152.version = ver;
		}
	}else{
		axp152.addr = AXP152_I2C_ADDR;
		axp152.version = ver;
	}
